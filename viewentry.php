...
if($_POST['submit']) {
	...
	mysql_query($sql);
	header("Location: http://" . "localhost/blog/" . $ss . "?id=" . $validentry);
}
else {
	...
	$commsql = "SELECT * FROM comments WHERE blog_id = " . $validentry . " ORDER BY dateposted DESC LIMIT 40;";
...
<?php echo $ss; ?>
<form action="<?php echo $ss . "?id=" . $validentry; ?>" method="post">
<table>
<tr>
	<td>Your name</td>
